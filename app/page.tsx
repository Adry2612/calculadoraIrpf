    ...
    <div className="flex flex-col flex-1 items-center justify-center  font-sans dark:bg-black">
      <div className=" bg-white shadow-lg px-8 py-12 flex-row flex w-full">
        <div className="flex flex-col items-start justify-center gap-6 w-full">
          <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200 mb-4">{home.heroTitle}</h1>
          <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-300 w-2/3">{home.heroSubtitle}</h2>
          <div className="flex flex-row gap-4">
            ...
            <button className="mt-4 px-6 py-2 bg-white border border-gray-800 text-gray-800 rounded-lg hover:bg-gray-100">{home.seeHowItWorks}</button>
          </div>
      ...
      <div className="flex flex-col w-full items-start justify-center bg-gray-100 px-8 py-12">
        ...
        <div className="flex flex-row items-center justify-center gap-4 w-full mt-8">
          ...
          <div className="flex flex-col rounded-2xl w-1/3 bg-white border border-gray-200 p-4 text-neutral-600 pb-12 px-6">
            ...
            <span className="font-bold text-2xl pb-6 text-gray-800"> {home.precisionCardTitle}</span>
          ...
          <div className="flex flex-col rounded-2xl w-1/3 bg-neutral-800 border border-gray-700 p-4 text-neutral-200 pb-12 px-6">
            ...
            <span className="font-bold text-2xl pb-6 text-zinc-50"> {home.multiplePayersCardTitle}</span>
          ...
          <div className="flex flex-col rounded-2xl w-1/3 bg-white border border-gray-200 p-4 pb-12 px-6">
            ...
            <span className="font-bold text-2xl pb-6 text-gray-800"> {home.optimizationCardTitle}</span>
